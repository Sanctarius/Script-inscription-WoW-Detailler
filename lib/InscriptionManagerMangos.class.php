<?php
class InscriptionManagerMangos extends InscriptionManager
{
    ...
    {
        $req = $this->_db->prepare("INSERT INTO account (username, sha_pass_hash, gmlevel, email, expansion, last_ip) VALUES (:username, :sha_pass_hash, :gmlevel, :email, :expansion, :last_ip)");
        
        $req->bindValue(":username", $compte->pseudo(), PDO::PARAM_STR);
        $req->bindValue(":sha_pass_hash", $compte->SHA1Compte(), PDO::PARAM_STR);
        $req->bindValue(":gmlevel", 0, PDO::PARAM_INT);
